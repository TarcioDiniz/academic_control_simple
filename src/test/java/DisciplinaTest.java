...
public class DisciplinaTest {
    ...
    void adicionarAlunoDeveMatricularAluno() {
        ...
        Aluno aluno = new Aluno("A002", "Maria", "maria@email.com", "senha002", new Horario(LocalTime.of(13, 0), LocalTime.of(17, 0)));
    ...
    void getNumeroAlunosDeveRetornarQuantidadeCorreta() {
        ...
        disciplina.adicionarAluno(new Aluno("A003", "Pedro", "pedro@email.com", "senha003", new Horario(LocalTime.of(18, 0), LocalTime.of(22, 0))));
        disciplina.adicionarAluno(new Aluno("A004", "Luiza", "luiza@email.com", "senha004", new Horario(LocalTime.of(8, 0), LocalTime.of(12, 0))));
